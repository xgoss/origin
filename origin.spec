...
%{!?commit:
%global commit 06dc0dc8e3074744deffe9237a4ce2b782a0056a
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_COMMIT=06dc0dc8e3 OS_GIT_VERSION=v3.7.0-alpha.1+06dc0dc-531 OS_GIT_MAJOR=3 OS_GIT_MINOR=7+ OS_GIT_TREE_STATE=clean
}
