...
%{!?commit:
%global commit f03551f7391cb1988b5110f15fd0508e11d34369
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_COMMIT=f03551f739 OS_GIT_VERSION=v3.7.0-alpha.1+f03551f-546 OS_GIT_MAJOR=3 OS_GIT_MINOR=7+ OS_GIT_TREE_STATE=clean
}
